...
wav2Lip_output = "inputs/wav2lip_out/output.mp4"
checkpoint_path = "checkpoints/wav2lip_gan.pth"


class Wav2LipCall:

	def __init__(self, face, audio, outfile) -> None:
	...
	def load_model(self, path):
		...
		if not os.path.isfile(path):
			...
			print("Downloading")
			response = requests.get("https://huggingface.co/Non-playing-Character/Wave2lip/resolve/main/wav2lip_gan.pth?download=true")
	...
	def main(self):
		...
		command = 'ffmpeg -y -i {} -i {} -strict -2 -q:v 1 {}'.format(audio_file_path, 'temp/result.avi', wav2Lip_output)
